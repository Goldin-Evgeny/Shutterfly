...
export const Game = () => {
  ...
  const getResultText = () => {
    if (!result)
      return gameMode === 'pve' ? pveResultTexts.default : resultTexts.default;
  ...
  return (
    <div className="space-y-6 max-w-md mx-auto">
      ...
      <Card className="min-h-[200px]">
        <CardHeader>
          <CardTitle className="text-center text-xl">
            {result ? (
              <ComicText className="text-2xl" fontSize={2} key={result}>
                {getResultText()}
              </ComicText>
            ) : (
              getResultText()
          ...
          <div className="flex justify-center">
            <div className="relative w-48 h-40">
              ...
              <Button
                ...
                size="lg"
              >
                <img src={choiceIcons.rock} alt="rock" className="w-8" />
              </Button>
              ...
              <Button
                ...
                size="lg"
              >
                <img src={choiceIcons.paper} alt="paper" className="w-8" />
              </Button>
      ...
      {/* Reset Button */}
      {(result ||
        (gameMode === 'pve' && (playerChoice || getOpponentChoice())) ||
        (gameMode === 'pvp' && playerChoice && player2Choice)) && (
        <div className="flex justify-center">
