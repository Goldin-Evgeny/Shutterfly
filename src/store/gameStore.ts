    ...
    if (state.gameMode === 'pve') {
      ...
      set(state => {
        const newPlayerScore =
          result === 'win' ? state.playerScore + 1 : state.playerScore;
        const newComputerScore =
          result === 'lose' ? state.computerScore + 1 : state.computerScore;
      ...
      if (state.currentPlayer === null) {
        ...
        set(state => {
          ...
          const newPlayer2Score =
            result === 'lose' ? state.player2Score + 1 : state.player2Score;
